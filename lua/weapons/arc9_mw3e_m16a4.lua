...
SWEP.WorldModel = "models/weapons/arc9/c_mw3e_m16a4.mdl"
...
SWEP.Attachments = {
    {
        ...
        Pos = Vector(3, 0, 3.8),
        Ang = Angle(0, 0, 0),
        Category = {"bo1_optic", "mw3_m4_irons", "bo1_rail_riser"},
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Category = {"mwc_m203", "bo1_rail_underbarrel"},
