...
SWEP.Description = [[
    British .50 caliber precision rifle. Very heavy, very powerful and extremely dangerous in the right hands.
]]
SWEP.Trivia = {
...
SWEP.WorldModel = "models/weapons/arc9/c_mw3e_as50.mdl"
