...
SWEP.ViewModel = "models/weapons/arc9/c_cod4_mp5.mdl"
SWEP.WorldModel = "models/weapons/w_smg_mp5.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_cod4_mp5.mdl"
...
SWEP.IronSights = {
    Pos = Vector(-3.45, -1, 1.5),
    Ang = Angle(0.015, 0.35, 0),
    Magnification = 1.1,
    ViewModelFOV = 60,
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Pos = Vector(11, 0, 1.2),
        Ang = Angle(0, 0, 0),
        Category = {"cod_muzzle_smg", "cod_muzzle_pistol", "cod4e_mp5_barrel"},
    },
    {
