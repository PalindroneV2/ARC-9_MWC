...
SWEP.ViewModel = "models/weapons/arc9/c_mw2e_tavor.mdl"
SWEP.WorldModel = "models/weapons/w_rif_famas.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/w_mw2e_tavor.mdl"
...
SWEP.RecoilRandomUp = 0.245
SWEP.RecoilRandomSide = 0.43
...
SWEP.ShootSound = "ARC9_MW2E.Tavor_Fire"
...
SWEP.CustomizePos = Vector(10, 35, 4.5)
...
SWEP.HookP_NameChange = function(self, name)
    ...
    local gunname = "IMI Tavor TAR-21"

    if attached["bo1_pap"] then gunname = "Malevolent Redeemer" end
...
SWEP.Attachments = {
    {
        ...
        Ang = Angle(0, 0, 0),
        Category = {"cod_optic"},
        InstalledElements = {"mainoptic","tavorcord"},
    },
    {
        PrintName = "Muzzle",
        Bone = "j_gun",
        Pos = Vector(10.2, 0, 0.9),
        Ang = Angle(0, 0, 0),
    ...
    },
    {
        ...
        RequireElements = {"tavorcord"}
    },
    {
        PrintName = "Tactical Right",
        DefaultCompactName = "TAC R",
        Bone = "j_gun",
        Pos = Vector(3.7, 0.65, 0.9),
        Ang = Angle(0, 0, -90),
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = "first_draw",
        EventTable = {
            {s = "ARC9_MW2E.Tavor_Chamber", t = 1 / 35},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        Time = 2.35,
        EventTable = {
            {s = "ARC9_MW2E.Tavor_MagOut", t = 0.15},
            {s = "ARC9_MW2E.Tavor_MagIn", t = 1.3}
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "ARC9_MW2E.Tavor_MagOut", t = 0.15},
            {s = "ARC9_MW2E.Tavor_MagIn", t = 1.3},
            {s = "ARC9_MW2E.Tavor_Chamber", t = 1.95}
        },
        IKTimeLine = {
            {
                t = 0,
