...
SWEP.ViewModel = "models/weapons/arc9/c_mw3e_usas12.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_mw3e_usas12.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_mw3e_usas12.mdl"
...
SWEP.HookP_NameChange = function(self, name)
    ...
    if attached["bo1_pap"] then
        gunname = "Unending Salvo Assault"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        Time = 59 / 30,
        EventTable = {
            {s = "ARC9_MW3E.USAS12_Chamber", t = 0.5 / 1.15},
        },
    },
    ["fire"] = {
        Source = {
    ...
    ["reload"] = {
        ...
        Time = 3.5 / 1.15,
        EventTable = {
            {s = "ARC9_MW3E.USAS12_MagOut", t = 0.5 / 1.15},
            {s = "ARC9_MW3E.USAS12_MagIn", t = 2.2 / 1.15},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "ARC9_MW3E.USAS12_MagOut", t = 0.5 / 1.15},
            {s = "ARC9_MW3E.USAS12_MagIn", t = 2.2 / 1.15},
            {s = "ARC9_MW3E.USAS12_Chamber", t = 2.8 / 1.15},
        },
        IKTimeLine = {
            {
                t = 0,
