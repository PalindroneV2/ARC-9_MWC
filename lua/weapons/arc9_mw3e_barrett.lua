...
SWEP.ViewModel = "models/weapons/arc9/c_mw3e_barrett.mdl"
SWEP.WorldModel = "models/weapons/w_snip_awp.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_mw3e_barrett.mdl"
...
SWEP.ShootSound = "ARC9_MW3E.Barrett_Fire"
...
SWEP.CustomizePos = Vector(23.5, 35.5, 4)
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        Time = 3.25,
        EventTable = {
            {s = "ARC9_MW3E.Barrett_Lift", t = 1 / 60},
            {s = "ARC9_MW3E.Barrett_MagOut", t = 0.5},
            {s = "ARC9_MW3E.Barrett_MagIn", t = 1.95},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            {s = "ARC9_MW3E.Barrett_Lift", t = 1 / 60},
            {s = "ARC9_MW3E.Barrett_MagOut", t = 0.65},
            {s = "ARC9_MW3E.Barrett_MagIn", t = 2.5},
            {s = "ARC9_MW3E.Barrett_Chamber", t = 3.5},
        },
        IKTimeLine = {
            {
                t = 0,
