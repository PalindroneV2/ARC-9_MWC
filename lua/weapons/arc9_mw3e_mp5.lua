...
SWEP.ViewModel = "models/weapons/arc9/c_mw3e_mp5.mdl"
SWEP.WorldModel = "models/weapons/w_smg_mp5.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/c_mw3e_mp5.mdl"
...
SWEP.ShootSound = "ARC9_MW3E.MP5_Fire"
...
SWEP.StandardPresets = {
    "[FNG]XQAAAQBBAQAAAAAAAAA9iIIiM7tupQCpjrtF9qJbeNZaSCEX4Y6O26HmkmevSb+fdsDiWk4Op676QH8yPWmN5labcPKStMqF8QVSn/i5aWVnPi5ddbqSRPzGQb7Brs6Wiu3asRVMnvew34cTdK2x4fDd5fP434hVwXRciUUEgAOntzrLmLyN1ljJ6dDiAgA=",
    "[Shadow Company]XQAAAQBcwwwwXAQAAAAAAAAA9iIIiM7tuo1AtT7XoJcfMnTqNz3qkNZKKHt0QDkD4X4p6VgFXiAHQLbGTX6sxLGXJK8lmIcOmf7eBDQXuf2AjVSPdCWVZpXUqGVOGhXKriwgsLujYdeF6riZiwvqgXr2QqTDhmuYj+0fnk5lqg7ljYP5frIRXcOhxSyDnSyRskY3NYvahAA==",
}
...
SWEP.Hook_ModifyBodygroups = function(self, data)
    ...
    if attached["mount"] and !attached["mp5_ics"] then
        vm:SetBodygroup(4,1)
    end
    if attached["top_g36c"] then
        vm:SetBodygroup(5,1)
        vm:SetBodygroup(4,2)
            if attached["g36_mount"] then
                vm:SetBodygroup(4,3)
            end
    end
...
SWEP.HookP_NameChange = function(self, name)
    ...
    gunname = fucname .. letname .. number

    if attached["bo1_pap"] then
        gunname = "MP115 Nimrod"
    end
...
SWEP.Attachments = {
    {
        PrintName = "Optic",
        Bone = "j_gun",
        Pos = Vector(2, 0, 3.875),
        Ang = Angle(0, 0, 0),
        Category = {"cod_optic", "cod_rail_riser", "mwc_mp5_rail"},
        InstalledElements = {"mount"},
    },
    {
        PrintName = "Handguard",
        DefaultCompactName = "A3",
        Bone = "j_gun",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(5, 0, 2),
        Category = {"mwc_mp5_handguard"},
        Installed = "mwc_mp5_barrel_ris",
    },
    {
        PrintName = "Muzzle",
        Bone = "j_gun",
        Scale = Vector(1,1.25,1.25),
        Pos = Vector(14.55, 0, 2.175),
        Ang = Angle(0, 0, 0),
        Category = {"cod_muzzle_smg", "cod_muzzle_pistol","mwc_mp5_sd"},
    },
    {
        PrintName = "Underbarrel",
        Bone = "j_gun",
        Scale = Vector(1,1,1),
        Pos = Vector(10.55, 0, 1.5),
        Ang = Angle(0, 0, 0),
        Category = {"cod_rail_underbarrel"},
        ExcludeElements = {"mp5_ris","mp5_ics"},
    },
    {
        PrintName = "Stock",
        Bone = "j_gun",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(-10, 0, 1),
        Category = {"mwc_stocks","mwc_stock_ul"},
